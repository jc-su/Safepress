#!/usr/bin/env python3
"""
Run experiments for new models (Qwen2.5-7B and SmolLM3-3B) after fixing issues.
"""
import gc
import sys
import traceback
...
def main():
    ...
    # Full pipeline for both models
    for ms in ["qwen25_7b", "smollm3_3b"]:
        ...
        for bits in [3, 4, 8]:
            experiments.append((f"{bits}-bit SSMP {ms}", lambda ms=ms, b=bits: run_ssmp(ms, b)))
